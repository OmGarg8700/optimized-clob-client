 ...
 * @returns SignedOrder
 */
export declare const buildOrder: (eoaSigner: Wallet | JsonRpcSigner, eoaSignerAddress: string, exchangeAddress: string, chainId: number, orderData: OrderData) => Promise<SignedOrder>;
