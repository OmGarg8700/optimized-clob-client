...
export declare const createL2Headers: (_signer: Wallet | JsonRpcSigner, creds: ApiKeyCreds, l2HeaderArgs: L2HeaderArgs, _timestamp?: number, signerAddress?: string) => Promise<L2PolyHeader>;
