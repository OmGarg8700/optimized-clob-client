...
export declare class ClobClient {
    ...
    constructor(host: string, chainId: Chain, signerAddress: string, signer?: Wallet | JsonRpcSigner, creds?: ApiKeyCreds, signatureType?: SignatureType, funderAddress?: string, geoBlockToken?: string, useServerTime?: boolean, builderConfig?: BuilderConfig, getSigner?: () => Promise<Wallet | JsonRpcSigner> | (Wallet | JsonRpcSigner), retryOnError?: boolean);
    getOk(): Promise<any>;
